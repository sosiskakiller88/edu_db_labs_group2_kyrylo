...
## Сценарій реєестрації користувача в системі
...
## Сценарій авторизації користувача в системі
...
## Сценарій локування користувача
